...
const StateEffectHookComp = () => {
    ...
    // 클래스컴포넌트의 라이프 사이클과 동일하게 사용할 수 있다
    // 이펙트훅 : componentWillMount()와 componetnWillUpdate() 내용을 같이 가지고 있다
    // 마운트될때와 업데이트될때 실해이 된다
    useEffect(()=>{
        ...
        //     console.log("종료하였습니다")
        // })
    }); // 두번째인수 값을 넣지 않을때, 모든 state와 props 값에 대해 실행
    ...
    // 특정한 state의 값이 바뀔때 실해하고 싶을때 useEffect 사용
    useEffect(()=> {
        console.log(`카운트가 증가였습니다`);
    },[count])
